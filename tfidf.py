...
def tf_idf_rapport(term, document_tokens, document_tokens_list):
	...
	print "First 5 document tokens:", document_tokens
...
# Simple sample usage
term = "alice"
document_tokens1 = simple_tokenizer("This is a test document about living next door to Alice.")
...
tf_idf_rapport(term, document_tokens1, document_tokens_list)
